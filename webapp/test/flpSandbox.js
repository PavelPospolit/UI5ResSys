		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#reservierungssystem-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"reservierungssystem-display": {
								"semanticObject": "reservierungssystem",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=reservierungssystem",
									"url": sap.ui.require.toUrl("reservierungssystem")
								}
							}
						}
					}
